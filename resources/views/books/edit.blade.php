    ...
    <div class="my-3">
        ...
        <form method="POST" action="{{ route('books.update', $book->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="book_title" name="title" value="{{ old('title', $book->title) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="book_quantity" name="quantity" value="{{ old('quantity', $book->quantity) }}" required>
            </div>
            
            {{-- field file --}}
            <div class="mb-3">
                <label for="book_file" class="form-label">File Buku (PDF):</label>
            ...
            {{-- field cover --}}
            <div class="mb-3">
                <label for="book_cover" class="form-label">Cover Buku (jpeg/jpg/png):</label>
